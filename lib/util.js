...
exports.mcSampler = exports.mcSample = exports.addStandings = exports.mergeFrequencyMaps = exports.getLeagueGames = exports.getLeagueStandings = exports.pointsFromGame = exports.leagueToID = undefined;
 ...
 * @returns {Promise}
 */
var getLeagueGames = exports.getLeagueGames = _bluebird2.default.method(function (league) {
...
var mcSample = exports.mcSample = function mcSample(games, pts) {
    // MapReduce :D
    var gameResults = games.map(function (_ref7) {
        var team1 = _ref7.team1,
            team2 = _ref7.team2,
            prob1 = _ref7.prob1,
            prob2 = _ref7.prob2,
            probtie = _ref7.probtie;
...
var mcSampler = exports.mcSampler = function mcSampler(pts) {
    return _bluebird2.default.method(function (games, N) {
        ...
        for (var i = 0; i < N; i++) {
            ...
            var sample = mcSample(games, pts).sort(function (_ref8, _ref9) {
