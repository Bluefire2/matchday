...
exports.mcSampler = exports.mcSample = exports.teamOrderingFromGames = exports.addStandings = exports.mergeFrequencyMaps = exports.getLeagueGames = exports.getLeagueStandings = exports.pointsFromGame = exports.leagueToID = undefined;
...
var mcSample = exports.mcSample = function mcSample(teamOrdering, games, pts) {
     ...
     */
    var gameResults = games.map(function (_ref8) {
        var team1 = _ref8.team1,
            team2 = _ref8.team2,
            prob1 = _ref8.prob1,
            prob2 = _ref8.prob2,
            probtie = _ref8.probtie;
    ...
    return gameResults.reduce(function (acc, _ref9) {
...
var mcSampler = exports.mcSampler = function mcSampler(games, pts) {
    ...
    return _bluebird2.default.method(function (N) {
        ...
        for (var i = 0; i < N; i++) {
            var sample = mcSample(ordering, games, pts).sort(function (_ref11, _ref12) {
                var teamA = _ref11.team;
                var teamB = _ref12.team;
